...
<div class="py-4 relative bg-gray-800 overflow-hidden">
    <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
        ...
        <div class="hidden lg:flex items-center px-2">
            <div class="">
                <div class="flex space-x-2 bg-gray-700 hover:bg-gray-600 px-3 py-2 rounded-xl">
                    ...
                    <a href="tel:+74951475550" class="text-gray-50 rounded-md text-xl font-bold ">+7 (495) 147-55-50</a>
                </div>
            </div>
        </div>
    </nav>
