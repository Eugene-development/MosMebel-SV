<script>
    ...
    switch (option) {
        case '1':
            text_style = 'text-style-1'
            bg_color = 'bg-color-1'
            break;
        case '2':
            text_style = 'text-style-2'
            bg_color = 'bg-color-2'
            break;
        default:
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div class="mt-8 border-t border-gray-50 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p class="mt-8 text-base text-gray-50 md:mt-0 md:order-1">
                &copy; {dataStart}-{yearNow} Интернет магазин стройматериалов, отделочных материалов и пластиковых окон "Орбита-Строй".
