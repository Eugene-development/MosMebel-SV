                ...
                <div class="hidden md:block mr-10">
                    <div class=" flex items-center md:ml-6">
                        ...
                        <div class="hidden lg:flex items-center px-2">
                            <div class="">
                                <div class="flex space-x-4 bg-gray-700 hover:bg-gray-600 px-4 py-0.5 mr-4 rounded-xl items-center">
                                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                        ...
                        <button type="button" class="bg-gray-800 p-1 ml-2 rounded-full text-cyan-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
