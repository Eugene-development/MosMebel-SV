                ...
                <div class="hidden md:block mr-10">
                    <div class=" flex items-center md:ml-6">
                        ...
                        <div class="hidden lg:flex items-center">
                            <div class="">
                                <div class="flex space-x-2 bg-gray-700 hover:bg-gray-600 px-4 py-0.5 mr-1 rounded-xl items-center antialiased">
                                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                                    ...
                                    <a href="tel:+74951475550" class=" text-gray-50 rounded-md text-base font-bold ">+7 (495) 147-55-50</a>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-50" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    ...
                                    <p class="text-gray-50 rounded-md text-base font-bold">info@mos-mebel.org</p>
                                </div>
                            </div>
                        </div>
